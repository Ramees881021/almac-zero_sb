...
// --- Bulk Import ---
const TEMPLATE_COLUMNS = ['Supplier', 'Method (supplier/waste_type/average/spend)', 'Material', 'Treatment', 'Weight (tonnes)', 'Proportion (%)', 'Apportioned (kg CO2e)', 'Spend (thousands)', 'Description'];
        ...
        const parsed = dataRows.map(row => {
          ...
          switch (method) {
            ...
            case 'spend':
              ...
              qty = spend; unit = `${currencySymbol}k`; tco2e = spend * (SPEND_FACTORS.waste?.factor || 0.21);
              break;
          }
